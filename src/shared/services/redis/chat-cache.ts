...
import { IReaction } from '@reaction/interfaces/reactions-interfaces';
...
export class MessageCache extends BaseCache {
  ...
  /**
   *
   * get chat message based on convarsationId cache
   *
   */
  ...
  /**
   *
   * update chat messages read true
   *
   */
